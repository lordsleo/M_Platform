...
namespace M_Platform.Service.App
{
    public partial class GetAppList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string warning = string.Format("参数CodeCompany，AppType不能为nul！举例：http://218.92.115.55/M_Platform/Service/App/GetAppList.aspx?DeviceType=iOS&AppType=0");
